...
class myBrowser:
    def __init__(self, dl_dir='C:\KS\SZOIscraper', headless=1):
        self.dl_dir = dl_dir
    ...
    def enable_download_in_headless_chrome(self):
        ...
        self.browserInstance.command_executor._commands["send_command"] = ("POST", '/session/$sessionId/chromium/send_command')
